...
public static class RoslynExtensions
{
    ...
    /// <summary>
    /// Returns a list of all declaration syntax nodes for the given symbol.
    /// </summary>
    public static IEnumerable<SyntaxNode> GetDeclarationNodes(this ISymbol symbol)
    {
    ...
    /// <summary>
    /// Returns true if the text appears in the leading trivia of the declaration syntax nodes of the symbol.
    /// </summary>
    public static bool ContainsInTrivia(this ISymbol symbol, string text)
    {
        return symbol.GetDeclarationNodes().Any(d => ContainsInTrivia(d, text));
    }

    /// <summary>
    /// Returns true if the text appears in the leading trivia of the syntax node.
    /// </summary>
    public static bool ContainsInTrivia(this SyntaxNode node, string text)
    {
